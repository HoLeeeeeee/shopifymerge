...
(function(){
  ...
  theme.CartForm = (function() {
    ...
    function CartForm(form) {
      ...
      this.subtotals = form.querySelectorAll(selectors.subTotal);
    ...
    CartForm.prototype = Object.assign({}, CartForm.prototype, {
      ...
      cartMarkup: function(text) {
        ...
        this.subtotals.forEach(s=>{
          s.innerHTML = theme.Currency.formatMoney(subtotal, theme.settings.moneyFormat);
        })
      ...
      updateSubtotal: function(subtotal) {
        ...
        this.form.querySelectorAll(selectors.subTotal).forEach(s=>{
          s.innerHTML = theme.Currency.formatMoney(subtotal, theme.settings.moneyFormat);
        })
      },
  ...
  theme.Slideshow = (function() {
    ...
    slideshow.prototype = Object.assign({}, slideshow.prototype, {
      ...
      slideChange: function(index) {
       ...
       //  Slideshow Bottom Rangebar
        if($(this).find(".slideshow-rangebox") && $(window).width() > 768){
          let nowindex = index + 1;
          let pecentran = nowindex*100/parseInt($(".slideshow-rangebox").data("number"), 10)+'%';
          // console.log(parseInt($(".slideshow-rangebox").data("number"), 10));
          // console.log(parseInt($(this).find(".slideshow-rangebox").data("number"), 10));
          // console.log(nowindex*100);
          $(".slideshow-rangebox>span").css("width",pecentran);
        }
      ...
      updateCartButton: function(evt) {
        ...
        if (variant) {
          if (variant.available) {
            ...
            if($(".pro-stickbar")){
             $(".pro-stickbar .add-to-cart").removeClass("disabled").children("span").text("Add to cart");
             $(".product-single__form .bthho").removeClass("disabled");
            }
          } else {
            ...
            if($(".pro-stickbar")){
              $(".pro-stickbar .add-to-cart").addClass("disabled").children("span").text("Sold Out");
              $(".product-single__form .bthho").addClass("disabled");
             }
          }
        } else {
      ...
      updatePrice: function(evt) {
        ...
        if (variant) {
          ...
          if (variant.compare_at_price > variant.price) {
            ...
            if($(".bstick-price")){
              $(".bstick-nowprice").html(theme.Currency.formatMoney(variant.price, theme.settings.moneyFormat))
              let chapri = variant.compare_at_price - variant.price;
              $(".savemon-bot").html(theme.Currency.formatMoney(chapri, theme.settings.moneyFormat));
              $(".bstick-save").removeClass("hide");
            }
          } else {
            if($(".bstick-price")){
              $(".bstick-nowprice").html(theme.Currency.formatMoney(variant.price, theme.settings.moneyFormat))
              $(".bstick-save").addClass("hide");
            }
